...
![“列表拖动排序”和“卡片抽屉效果”代表作](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/事件分发机制优雅交互代表作.png)
...
![快乐](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/快乐.png)

须知道，一山更比一山高。今年力行 “书上学” 苦练基本功，认真学习了玉刚哥的《Android开发艺术探索》，书中的几个问题 “**侧面迂回**” 暴击了我掌握的事件分发机制“不过尔尔”。

![不过尔尔](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/不过尔尔.png)
...
![5 Whys](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/5whys.jpg)
...
![考考你事件分发](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/考考你“事件分发”.png)
...
![玉刚哥的几行伪代码](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/经典事件分发机制伪代码.png)

基于上述我夹带的伪代码画了一幅流程图，如下图所示：▼

![伪代码流程图](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/事件分发机制简图.png)
...
![送分题](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/这是一道送分题.jpeg)
...
![爱谁尴尬谁尴尬](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/buganga.png)
...
![事件流火车模型](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/事件流火车模型.png)
...
![按键响应调用](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/人机交互.png)

所以，事件大概率被 DecorView 消费了。如果继续靠猜，那效率就有点低了。最直接最有效的方式就是 Debug 源码。

![最直接最有效的方式](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/靠猜.png)
...
![Android系统页面布局图](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/View树系统布局.png)
...
![dispatchTouchEvent 逻辑源码](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/ViewGroup中dispatchTouchEvent.png)

这个问题看似简单，但实际能回答上来的才是真的高手。

![](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/这是高手.png)

画一幅时序图总结一下：▼

![时序图](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/不设按键监听点击分发.png)

但可能有同学会问，不设置按键监听情况下，没啥实际意义，大部分人不会关心这种情况，换一题。

![换一题](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/我们看下一道题.jpg)
...
![我也不知道](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/嗯那个我也不知道.jpeg)
...
![我的心再等待](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/我的心在等待.png)
...
![不敢说精通](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/精通Java.jpeg)
...
![灵魂拷问](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/灵魂拷问三连.jpg)
...
![没完没了了](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/有完没完.jpeg)

磨刀不耽误砍柴，画两幅时序图总结一下：▼

![拦截 DOWN 时序图](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/设按键监听&拦截点击分发-DOWN.png)

![拦截 UP 时序图](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/设按键监听&拦截点击分发-UP.png)
...
![最后一题](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/呼叫大佬最后一道题咋做Over.jpeg)

基于上述按键逻辑，DOWN 事件由 TextView 消费没有争议，关键问题就是第一个不在红色区域但在蓝色区域的 MOVE 事件怎么处理，以及最终的 UP 事件到底是谁消费？
<br>太伤头发了...

![太伤头发了](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/duang.png)
...
![套路](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/套路.png)
...
![按键移动分发时序图](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/设按键监听&按键移动分发.png)

### 总结

受《Android 开发艺术探索》的启发，尝试使用简明扼要的伪代码来总结回顾一下事件分发机制。

![事件分发机制伪代码](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/事件分发机制伪代码.png)
...
![](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/事件分发机制钓钩模型.png)

引用柳宗元《江雪》为本篇做个结尾：孤舟蓑笠翁，独**钓**寒江雪。

![](https://shengshuqiang.github.io/assets/dispatchTouchEvent-fishinghook/独钓寒江雪.jpeg)